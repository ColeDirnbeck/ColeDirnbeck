...
def _test_two():
    ...
    # create a Stock object with the spot_price and the sigma
    stock = Stock(opt=None, db_connection=None, ticker='Test Two', spot_price=182, sigma=0.2)

    # create European call and put option objects with the time_to_expiry and the strike price
    call_option = EuropeanCallOption(stock, time_to_expiry=0.5, strike=175)
    put_option = EuropeanPutOption(stock, time_to_expiry=0.5, strike=175)
